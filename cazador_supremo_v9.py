...
def main():
    ...
    print("="*60)
    print("🏆 CAZADOR SUPREMO v9.0 - Sistema de Monitorización de Vuelos")
    print("="*60)
    print(f"✅ Bot Token: {BOT_TOKEN[:20]}...")
    print(f"✅ Chat ID: {CHAT_ID}")
    print(f"✅ Vuelos configurados: {len(FLIGHTS)}")
    print(f"✅ Alerta mínima: €{ALERT_MIN}")
    print("="*60)
    ...
    print("✅ Bot activo! Comandos disponibles:")
    print("   /start - Bienvenida")
    print("   /supremo - Scan completo")
    print("   /status - Dashboard")
    print("   /rss - Ofertas flash")
    print("   /chollos - Hacks")
    print("   /scan ORIGEN DESTINO - Ruta específica")
